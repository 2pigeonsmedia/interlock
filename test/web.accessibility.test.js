...
test('dynamic decisions have specific names and narrow layouts wrap', () => {
  ...
  assert.match(ROOM_JS,
    /This name was used before\. The previous connection ended[\s\S]*Allow creates a new AI session; it does not restore the old one\./,
    'an ended-name Allow must explain that it creates a new generation');
